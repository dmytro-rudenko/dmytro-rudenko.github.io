...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_dist_vue_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_dist_vue_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_dist_vue_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__modules_Synt_js__);
/* Main JS File */
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).ready(function ($) {
  ...
  var controllers = [{
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeFrequency,
    plusKey: {
      letter: 'w',
      direction: 'plus',
      active: false
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeDetune,
    plusKey: {
      letter: 'r',
      direction: 'plus',
      active: false
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeTremoloFrequency,
    plusKey: {
      letter: 'y',
      direction: 'plus',
      active: false
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeTremoloDepth,
    plusKey: {
      letter: 'i',
      direction: 'plus',
      active: false
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeVibratoFrequency,
    plusKey: {
      letter: 's',
      direction: 'plus',
      active: false
    ...
    state: 0,
    maxState: 8,
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.changeVibratoDepth,
    plusKey: {
      letter: 'f',
      direction: 'plus',
      active: false
  ...
  var actions = [{
    name: 'Play',
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.playWave,
    letter: 'p'
  }, {
    name: 'Stop',
    event: __WEBPACK_IMPORTED_MODULE_3__modules_Synt_js___default.a.stopWave,
    letter: 'o'
  }, {
    name: 'Rec',
    event: 'StopRecord',
  ...
  var syntView = new __WEBPACK_IMPORTED_MODULE_2_vue_dist_vue_js___default.a({
    el: '#synt',
    data: {
  ...
  Object.defineProperty(this, "pitchShift", {
    set: function set(ps) {
      ...
      for (var pitch in oscillators) {
        oscillators[pitch].frequency.value = oscillators[pitch].baseFrequency * Math.pow(2, this._pitchShift / 1200);
      }
    },
    get: function get() {
...
var SYNT = /*#__PURE__*/function () {
  function SYNT() {
    _classCallCheck(this, SYNT);
  ...
  _createClass(SYNT, [{
    key: "playWave",
    value: function playWave() {
      if (Synt._oscillators['note']) {
        Synt._oscillators['note'].stop(0);
      }

      var oscillator = Synt._oscillators['note'] = Synt.audioContext.createOscillator();
    ...
    key: "stopWave",
    value: function stopWave() {
      Synt._oscillators['note'].stop(0);
    }
  }, {
    key: "changeFrequency",
    value: function changeFrequency(direction) {
      var oscillator = Synt._oscillators['note'];
    ...
    key: "changeDetune",
    value: function changeDetune(direction) {
      var oscillator = Synt._oscillators['note'];
    ...
    key: "changeWaveType",
    value: function changeWaveType(direction) {
      var oscillator = Synt._oscillators['note'];
      var waveTypes = ['sine', 'square', 'sawtooth'];
    ...
    key: "changeVolume",
    value: function changeVolume(direction) {
      if (direction === 'plus') {
    ...
    key: "changeTremoloFrequency",
    value: function changeTremoloFrequency(direction) {
      var tremolo = Synt.tremolo;
    ...
    key: "changeTremoloDepth",
    value: function changeTremoloDepth(direction) {
      var tremolo = Synt.tremolo;
    ...
    value: function changeVibratoFrequency(direction) {
      var vibrato = Synt.vibrato;
    ...
    value: function changeVibratoDepth(direction) {
      var vibrato = Synt.vibrato;
